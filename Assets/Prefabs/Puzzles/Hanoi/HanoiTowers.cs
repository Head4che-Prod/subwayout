...
public class HanoiTowers : MonoBehaviour
{
    ...
    private void Start()        // When game gets loaded
    {
        ...
        _tBall.Object.transform.localPosition = new Vector3(2.5f, 3.5f, 1.25f); // Put higher so it enters its collision last
    }
    ...
    private void OnBallEnterBox(GameObject ballObject, HanoiCollider box)
    {
        ...
        if (box.ContainedBall == null
            && (box.Height == 0 || HanoiCollider.colliderGrid[box.Bar, box.Height - 1].ContainedBall?.Weight > ball.Weight))
        {
